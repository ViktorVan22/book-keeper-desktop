...
适用于电脑端的记账 Web App，请搭配[后端代码](https://github.com/ViktorVan22/book-keeping-json-server)食用。  
预览动图：
...
![screen3.gif](https://github.com/ViktorVan22/book-keeper-desktop/blob/main/public/screen3.gif)
